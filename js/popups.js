...
function createGameMessagePUHandlerYNC(popup)
{
    ...
    // add caption
    popup.captionText = popup.scene.add.bitmapText(0, -90 + yOffset, 'gameFont_1', 'Caption', 31, 1).setOrigin(0.5);
    //popup.captionText.tint = 0x4f2930;
    popup.add(popup.captionText);

    // add message
    popup.messageText = popup.scene.add.bitmapText(0, -20 + yOffset, 'gameFont_0', 'Message', 31, 1).setOrigin(0.5);
    popup.messageText.tint = slotConfig.slotTextColor;
    popup.add(popup.messageText);

    // add buttons
    popup.addButton('okButton','middle_button', 'middle_button_hover', false, -100, 110 + yOffset);
    popup.addButton('noButton','middle_button', 'middle_button_hover', false, 100, 110 + yOffset);
    popup.addButton('exitButton','exit_button', 'exit_button_hover', false, 252, -190 + yOffset);
    ...
    // add button text
    popup.okText = popup.scene.add.bitmapText(-100, 103 + yOffset, 'gameFont_1', 'OK', 40, 1).setOrigin(0.5);
    popup.okText.tint = 0xFFFFFF;
    popup.add(popup.okText);

    popup.noText = popup.scene.add.bitmapText(100, 103 + yOffset, 'gameFont_1', 'NO', 40, 1).setOrigin(0.5);
