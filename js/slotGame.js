...
class SlotGame extends Phaser.Scene{
    ...
    preload(){
         ...
         progressBox.fillStyle(0xBB4157, 1);
         progressBox.fillRect((slotGame.config.width / 2) - 10 - 160, (slotGame.config.height / 2) - 10 + 330, 320, 40);
 
         this.load.on('progress', function (value) {
             //console.log(value);
             progressBar.clear();
             progressBar.fillStyle(0xFFCBE8, 1);
             progressBar.fillRect((slotGame.config.width / 2) -160, (slotGame.config.height / 2) + 330, 300 * value, 20);
         });
    ...
    create(){   
        ...
        // 10) debug
        // this.fpsText = this.add.bitmapText(this.centerX, this.centerY - 590, 'gameFont_1', 'fps: ', 40, 1).setOrigin(0.5);

        // 11) tests
        //  this.showWinCoinsMessage(20, 5000);
