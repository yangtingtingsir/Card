...
class SlotGame extends Phaser.Scene{
    ...
    preload(){
        ...
        this.load.audio('lose_clip', ['audio/witch/witchs_laugh.wav']);
        this.load.audio('background_clip', ['audio/witch/haunting_sequence.wav']);
        // this.load.audio('pointer_hit_clip', ['audio/pointer_hit.ogg', 'audio/pointer_hit.mp3' ]); 
